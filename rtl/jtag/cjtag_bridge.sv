            ...
            case (state)
                ...
                ST_OFFLINE: begin
                    ...
                    if (tckc_negedge) begin
                        `DEBUG2(`DBG_GRP_JTAG, ("[%0t] OFFLINE (state=%0d): Escape sequence ended, toggles=%0d",
                        ...
                        if (tmsc_toggle_count >= 5'd6 && tmsc_toggle_count <= 5'd7) begin
                            ...
                            `DEBUG2(`DBG_GRP_JTAG, ("[%0t] OFFLINE -> ONLINE_ACT (%0d toggles)",
                                   $time, tmsc_toggle_count));
                        `ifndef SYNTHESIS
                        end else if (tmsc_toggle_count >= 5'd8) begin
                            // Reset escape (8+ toggles) - stay in OFFLINE
                            `DEBUG2(`DBG_GRP_JTAG, ("[%0t] OFFLINE: Reset escape detected (%0d toggles), staying OFFLINE",
                                   $time, tmsc_toggle_count));
                        end else begin
                ...
                ST_ONLINE_ACT: begin
                    ...
                    if (tckc_negedge && tmsc_toggle_count >= 5'd8) begin
                        ...
                        `ifdef DEBUG
                        `DEBUG2(`DBG_GRP_JTAG, ("[%0t] ONLINE_ACT -> OFFLINE (reset escape: %0d toggles)",
                               $time, tmsc_toggle_count));
                        `endif
                    end
                ...
                ST_OSCAN1: begin
                    ...
                    if (tckc_negedge) begin
                        ...
                        if (tmsc_toggle_count >= 5'd4 && tmsc_toggle_count <= 5'd5) begin
                            `DEBUG2(`DBG_GRP_JTAG, ("[%0t] *** OSCAN1 -> OFFLINE *** (deselection escape detected, toggles=%0d)",
                                   $time, tmsc_toggle_count));
                        ...
                        // Check for reset escape (8+ toggles while TCKC was high)
                            ...
                            `DEBUG2(`DBG_GRP_JTAG, ("[%0t] *** OSCAN1 -> OFFLINE *** (reset escape detected, toggles=%0d >= 8)",
                                   $time, tmsc_toggle_count));
